...
{
    public class AulasProfessorPage2ViewModel : ViewModelBase

    {
        ...
        public AulasProfessorPage2ViewModel(INavigationService navigationService, 
        ...
        private async Task CarregarEventosAsync()
        {
            ...
            {
                response = await apiService.getEventosProfessor(parametro);
            }
            else
            {
